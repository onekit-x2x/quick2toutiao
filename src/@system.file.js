...
module.exports = {
  ...
  move(quick_object) {
    ...
    const srcPath = tt.env.USER_DATA_PATH + quick_srcUri.substring(10)
    const destPath = tt.env.USER_DATA_PATH + quick_dstUri.substring(10)
    PROMISE((SUCCESS) => {
  ...
  list(quick_object) {
    ...
    quick_object = null
    const fileSystemManager = tt.getFileSystemManager()
    const dirPath = tt.env.USER_DATA_PATH + quick_uri.substring(10)
    PROMISE((SUCCESS) => {
  ...
  get(quick_object) {
    ...
    quick_object = null
    const fileSystemManager = tt.getFileSystemManager()
    const filePath = tt.env.USER_DATA_PATH + quick_uri.substring(10)
    PROMISE((SUCCESS) => {
  ...
  access(quick_object) {
    ...
    PROMISE((SUCCESS, FAIL) => {
      const path = tt.env.USER_DATA_PATH + quick_uri.substring(10)
